...
| 项 | 值 |
|---|---|
| 当前状态 | U0+U1 全部完成；U2 主体完成：U2-1（516042b）/U2-3（fc4ddfe）/U2-5（f0e87c1）/U2-4（3710c0a）DONE；仅 U2-2 待 U3 台账；下一步 U3 全照片资产化；训练仍 NO-GO |
...
| 基线测试 | **372 passed，1 skipped**（主机 miniconda python3，U2-4 后全量回归） |
