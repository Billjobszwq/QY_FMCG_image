...
| 项 | 值 |
|---|---|
| 当前状态 | U0+U1+U2+U3 全部完成；U4-1/U4-2/U4-3 DONE + U4-4 机制 DONE（6baa389）；U4 剩余为真实人工审核 250 诊断批（waiting_human）；下一步 U5 Graph+Loop v2；训练仍 NO-GO |
...
| 基线测试 | **442 passed，1 skipped**（主机 miniconda python3，U4-4 后全量回归） |
