...
| 项 | 值 |
|---|---|
| 当前状态 | U0+U1 全部完成；U2 进行中：U2-1（516042b）/U2-3（fc4ddfe）/U2-5（f0e87c1）DONE；下一步 U2-4 业务语言统一，随后 U3 台账（U2-2 依赖 U3）；训练仍 NO-GO |
...
| 基线测试 | **369 passed，1 skipped**（主机 miniconda python3，U2-5 后全量回归） |
...
| U2 统一管理 MVP | **进行中**：U2-1/U2-3/U2-5 DONE（角色首页/识别四入口/幂等键+分页）；待 U2-4；U2-2 依赖 U3 台账 |
