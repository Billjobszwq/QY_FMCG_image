...
| 项 | 值 |
|---|---|
| 当前状态 | U0+U1 全部完成；U2 主体完成；U3 进行中：U3-1（4384b71）/U3-2（8899d25）DONE——不可变台账 38284 条守恒；下一步 U3-3 SHA 去重+近重复；U2-2 待 U3 台账接入；训练仍 NO-GO |
...
| 基线测试 | **384 passed，1 skipped**（主机 miniconda python3，U3-2 后全量回归） |
...
| U3/U4 全照片与 SAM 审核 | U3-1/U3-2 DONE（total_raw=38284 含重复；台账 38284 条全带 SHA、不可变、重跑幂等）；U3-3 去重进行中；250 审核项全部 pending；qa_v3 仅 120 张 |
