...
| 项 | 值 |
|---|---|
| 当前状态 | U0+U1+U2 全部完成；U3-1～U3-6 DONE（U3-6 入口+状态机+首批 500 已建队，98fa4cc；剩余 499 张需真实人工审核）；下一步 U4 SAM 闭环；训练仍 NO-GO |
...
| 基线测试 | **418 passed，1 skipped**（主机 miniconda python3，U3-6 后全量回归） |
...
| U3/U4 全照片与 SAM 审核 | U3-1～U3-6 DONE（台账 38284 守恒；SHA 唯一 30459；分流 0 泄漏；qpol_v2 11 维+不可变证据链；金标准首批 500 已建队 waiting_human，人工审核进行中 1/500）；250 审核项全部 pending；qa_v3 仅 120 张 |
