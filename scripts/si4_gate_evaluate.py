#!/usr/bin/env python3
"""SI4 T6：Gate 3.1 全量评估（evidence-driven，写入机器 gate.json）。
...
GATE_OUT = ROOT / ".eval" / "scope_v4" / "gate.json"
UAT_REPORT = ROOT / ".eval" / "scope_v4" / "uatv6" / "report.json"
BROWSER_REPORT = ROOT / ".eval" / "scope_v4" / "browser" / \
    "browser_evidence.json"
ISSUES = ROOT / "docs" / "implementation" / \
    "agentic-business-os-operational-scope-v4" / "ISSUES.md"
TEST_REPORT = ROOT / ".eval" / "scope_v4" / "test_report.json"
